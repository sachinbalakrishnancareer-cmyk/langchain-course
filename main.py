...
def main():
    ...
    result = agent.invoke({"messages": HumanMessage(content="Search Linkedin for any 2 Data Scientist L5 positions in Amazon or AWS in Seattle and list the details")})
    print(result)
